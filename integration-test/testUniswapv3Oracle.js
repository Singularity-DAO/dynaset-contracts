...
describe("Uniswapv3Oracle contract", function () {
  beforeEach(async () => {
      if (!initialized) await init();
  });
  	
  describe("Deployment of Uniswapv3Oracle", () => {

    it("Test deploy Uniswapv3Oracle", async () => {
      // deploy oracle
      const oracle = await uniswapv3Oracle_CF.deploy(uniswapv3_factory, observation_period, USDC, WETH);
      console.log("Deployed Uniswapv3Oracle");
      expect(await oracle.uniswapv3Factory())
          .to.be.equal(uniswapv3_factory);
